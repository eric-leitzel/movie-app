describe('omdb service', function () {
    ...
    it('should return movie search data', function () {
        ...
        var expectedUrl = function (url) {
            // .indexOf - return the index number from which the parameter first occurs; return -1 if not found
            // Below reads "return url argument when compared against "http://omdbapi.com" has an index value that is not equal to -1 (mock reponse as if it were "found")
